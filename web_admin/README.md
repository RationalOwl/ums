...
- 카카오 비즈니스 콘솔에서 먼저 카카오 채널을 등록한다.
- 템플릿관리>알림톡 연동 > 연동 체크 > '카카오톡 채널 관리'를 클릭 > 관리팝업이 나타난다.
- '+카카오톡채널연동'버튼을 클릭하여 카카오 비즈니스에서 등록한 채널과 연동한다.
- 연동추가된 카카오톡 채널은 연동된 카카오톡 채널 목록에 표시되고 선택할 수 있다.
